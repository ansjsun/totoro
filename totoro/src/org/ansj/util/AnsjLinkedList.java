...
public class AnsjLinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>{
	 ...
	 */
	public AnsjLinkedList(Collection<? extends E> c) {
		this();
		addAll(c);
	}
	...
	private class ListItr implements ListIterator<E> {
		...
		public void remove() {
			...
			try {
				AnsjLinkedList.this.remove(lastReturned);
	 ...
	 */
	public Object clone() {
		AnsjLinkedList<E> clone = null;
		try {
			clone = (AnsjLinkedList<E>) super.clone();
	...
	public void merager(Entry<E> ...entries){
