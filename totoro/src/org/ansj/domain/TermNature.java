...
public class TermNature {
	 ...
	 * 系统内置的几个
	 */
	public static final TermNature NULL = new TermNature("null", -10000) ;
	public static final TermNature NB = new TermNature("nb", 0) ;
	public static final TermNature EN = new TermNature("en", 0) ;
	...
	public static final TermNature[] TERM_NATURE_ARRAY = {NULL} ;
	
	public Nature nature;

	public int frequency;

	private TermNature(String natureStr, int frequency) {
